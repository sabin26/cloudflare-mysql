...
import { default as bufferCopy } from '../BufferCopy';
...
class Parser {
  ...
  parseString(length) {
    ...
    const value = textDecoder.decode(this._buffer.slice(offset, end));
