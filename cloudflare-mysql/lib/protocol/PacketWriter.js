...
class PacketWriter {
  ...
  writeUnsignedNumber(bytes, value) {
  ...
  writeLengthCodedBuffer(value) {
    var bytes = value.length;
    this.writeLengthCodedNumber(bytes);
    this.writeBuffer(value);
  }
  writeNullTerminatedBuffer(value) {
    this.writeBuffer(value);
    this.writeFiller(1); // 0x00 terminator
  }
  writeLengthCodedString(value) {
    if (value === null) {
  ...
  _allocate(bytes) {
    ...
    oldBuffer.copyWithin(this._buffer);
  }
}
